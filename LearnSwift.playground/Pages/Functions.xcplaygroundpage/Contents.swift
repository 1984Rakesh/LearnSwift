// Functions self contained block of code that has specific functions
...
// Monkey climbs 4 meter in one mintues and down 2 meter in next 1 min, how much will it need to climb 15 meters pole

...
//: Intresting example of closure capturing surroinding value
// this example is surely hard to grasp..
// in the exapmle below runningAmount and incrementAmount are not a part to increment function
// since they are refered by the increment function the are captured by reference

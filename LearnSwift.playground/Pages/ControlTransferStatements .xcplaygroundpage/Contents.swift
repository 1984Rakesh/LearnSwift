...
//:
//: **Continue**
//: * used within the loops to stop execution of current loop increment and conitnue with next loop
...
//: **label**
//: * stament are similar to goto and can be used by break and continue to move execution control to labled statment

...
//: Protocols as Types
// Protocol can be used as type, they can be used to define type of varialble or function parameter

//: Delegation
// Protocols can be used to implement delegation design pattern

//: Extension
// Protocols can be extended to provide default functionality, in other words you can have optional methods similar to Objective-C
